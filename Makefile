...
OFILES = main.o myLib.o font.o titlescreen.o leftarrow.o rightarrow.o uparrow.o downarrow.o text.o gameover.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = myLib.h font.h titlescreen.h leftarrow.h rightarrow.h uparrow.h downarrow.h text.h gameover.h
